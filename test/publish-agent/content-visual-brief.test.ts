...
} from '@content/publish-agent/content-visual-brief.js';
import type { ContentVisualCategoryBrief, ContentVisualCategoryKind } from '@kernel/kernel/visual-reference-types.js';
