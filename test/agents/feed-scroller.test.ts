...
import { FeedScroller, SEARCH_THRESHOLD } from '@automation/agents/feed-scroller.js';
import { SessionContext } from '@automation/agents/session-context.js';
import type { Soul } from '@kernel/kernel/soul-types.js';
import type { FeedScrolledPayload, SearchNeededPayload } from '@automation/event-bus/types.js';
