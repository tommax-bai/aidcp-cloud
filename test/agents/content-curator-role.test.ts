...
import { ContentCuratorRole } from '@automation/agents/content-curator-role.js';
...
import type { QualityPassPayload, QualityRejectPayload } from '@automation/event-bus/types.js';
