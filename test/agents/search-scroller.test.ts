...
import { SearchScroller, SEARCH_SCROLL_THRESHOLD } from '@automation/agents/search-scroller.js';
import { SessionContext } from '@automation/agents/session-context.js';
import type { Soul } from '@kernel/kernel/soul-types.js';
import type { SearchScrolledPayload, SearchNeededPayload } from '@automation/event-bus/types.js';
