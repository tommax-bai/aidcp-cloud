...
export const COLD_START_PLANS: ColdStartDayPlan[] = [
  { day: 1, quotas: { view: [30, 50], like: [0, 3], collect: [0, 1], comment: [0, 0], follow: [0, 1], publish: [0, 0] } },
  { day: 2, quotas: { view: [30, 50], like: [0, 3], collect: [0, 1], comment: [0, 0], follow: [0, 1], publish: [0, 0] } },
  { day: 3, quotas: { view: [50, 80], like: [5, 10], collect: [1, 3], comment: [0, 1], follow: [1, 2], publish: [0, 0] } },
  { day: 4, quotas: { view: [50, 80], like: [5, 10], collect: [1, 3], comment: [0, 1], follow: [1, 2], publish: [0, 0] } },
  { day: 5, quotas: { view: [80, 120], like: [10, 20], collect: [3, 5], comment: [1, 3], follow: [2, 3], publish: [0, 1] } },
  { day: 6, quotas: { view: [80, 120], like: [10, 20], collect: [3, 5], comment: [1, 3], follow: [2, 3], publish: [0, 1] } },
  { day: 7, quotas: { view: [80, 120], like: [10, 20], collect: [3, 5], comment: [1, 3], follow: [2, 3], publish: [0, 1] } },
];
